...
static const int PIN_OUT_33 = 33; // ขา 33 สำหรับ Output เป็น 1 ตลอด
...
static bool createEntities(){
  ...
  RCCHECK(rclc_subscription_init_default(&sub_cmd_dril_motor,&node,ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs,msg,Int16),"/tao/moter_dril"));
  RCCHECK(rclc_publisher_init_best_effort(&pub_fb_dril_motor,&node,ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs,msg,Int16),"/tao/moter_dril/rpm"));
...
// ========================== Arduino setup/loop ==========================
void setup(){
  // --- ตั้งค่า Pin 33 ให้เป็น 1 (HIGH) ตลอด ---
  pinMode(PIN_OUT_33, OUTPUT);
