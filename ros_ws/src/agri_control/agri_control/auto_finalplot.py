...
class AprilTagDetector(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("✅ AprilTag Node Started (Cube-Tag Tracking Enabled)")
    ...
    def image_callback(self, msg):
        ...
        # ---------------------------------------------------------
        # 1. ถ้ายังไม่เคยจำ ID ให้หา Tag ที่ใหญ่ที่สุดในเฟรมแล้วจำ ID นั้นไว้
        ...
        # 2. ถ้ามี ID เป้าหมายแล้ว ให้หา Tag ที่มี ID ตรงกัน "และมีพื้นที่ใหญ่ที่สุด"
        ...
        if best_tag is not None:
            ...
            if best_tag.pose_t is not None and best_tag.pose_R is not None:
                ...
                if self.robot_state == 'APPROACHING':
                    ...
                    curve_angular_speed = (-output_x) + (self.Kp_yaw * yaw_error_rad)
