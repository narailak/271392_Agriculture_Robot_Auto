        ...
        while rclpy.ok():
            ...
            if self.auto_active:
                if self.auto_paused:
                    ...
                    # --- เปลี่ยนแปลง State 15 ตามคำขอ ---
                    # ดัน Linear ลง 5 วินาที
                    ...
                    # สั่ง Gripper เปิด (60) ค้างไว้ แล้วดัน Linear ลงต่ออีก 2 วินาที
                        ...
                        if current_time - self.auto_timer < 2.0:
                            ...
                            self.auto_timer = current_time
                            self.auto_state = 17
                            self.get_logger().info("AUTO: Gripper CLOSED 25. Waiting 1.5s...")

                    # สลับ ปิด(25) -> เปิด(60) -> ปิด(25) -> เปิด(60) โดยเว้นช่วงละ 1.5 วิ (ปรับเวลาหน่วงตรงนี้ได้)
                        ...
                        if current_time - self.auto_timer >= 1.5:
                            ...
                            self.auto_timer = current_time
                            self.auto_state = 18
                            self.get_logger().info("AUTO: Gripper OPENED 60. Waiting 1.5s...")
                        ...
                        if current_time - self.auto_timer >= 1.5:
                            ...
                            self.auto_timer = current_time
                            self.auto_state = 20
                            self.get_logger().info("AUTO: Gripper OPENED 60. Executing FINAL STEP...")
